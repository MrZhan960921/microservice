package com.zcq.user.controller;

import com.zcq.thrift.user.UserInfo;
import com.zcq.thrift.user.dto.UserDTO;
import com.zcq.user.redis.RedisClient;
import com.zcq.user.response.LoginResponse;
import com.zcq.user.response.Response;
import com.zcq.user.thrift.ServiceProvider;
